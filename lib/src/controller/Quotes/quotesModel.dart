...
List<Quote> quotes = [
  ...
  Quote('20', 'Plans are nothing; planning is everything.', 'Productivity',
      'Dwight D. Eisenhower'),
  Quote('21', "Don't wait. The time will never be just right.", 'Productivity',
      'Audrey Hepburn'),
  Quote(
      '22',
  ...
  Quote(
      ...
      'Productivity',
      'John Wooden'),
  Quote('26', 'Effective performance is preceded by painstaking preparation.',
      'Productivity', 'Arnold Schwarzenegger'),
  Quote('27', 'The way to get started is to quit talking and begin doing.',
      'Productivity', 'Vince Lombardi'),
  Quote(
      '28',
  ...
  Quote(
      ...
      'Productivity',
      'Amy Poehler'),
  Quote('33', 'Plans are nothing; planning is everything.', 'Productivity',
      'T.S Eliot'),
  Quote(
      '34',
  ...
  Quote(
      ...
      'Productivity',
      '-Henry David Thoreau'),
  Quote('39', 'I get to do what I like to do every single day of the year.',
      'Productivity', 'Samuel Johnson'),
  Quote(
      '40',
  ...
  Quote(
      ...
      'Productivity',
      'Michael Altshuler'),
  Quote('44', 'Time is not refundable; use it with intention.', 'Productivity',
      'Mark Twain'),
  Quote('45', 'Starve your distraction and feed your focus.', 'Productivity',
      'John Wooden'),
  Quote('46', 'Create with the heart; build with the mind.', 'Productivity',
      'Arnold Schwarzenegger'),
  Quote(
      '47',
  ...
  Quote(
      ...
      'Productivity',
      'Samuel Johnson'),
  Quote('50', 'Remember that failure is an event, not a person.',
      'Productivity', 'Michael Jordan'),
  Quote(
      '51',
  ...
  Quote(
      ...
      'Productivity',
      'T.S Eliot'),
  Quote('54', 'There is no substitute for hard work.', 'Productivity',
      'Mark Twain'),
  Quote(
      '55',
  ...
  Quote(
      ...
      'Productivity',
      '-Henry David Thoreau'),
  Quote('59', "Words may show a man's wit but actions will show his meaning.",
      'Productivity', 'Samuel Johnson'),
  Quote(
      '60',
      ...
      'Productivity',
      'Michael Jordan'),
  Quote('62', 'Never mistake motion for action.', 'Productivity',
      'Alexander the Great'),
  Quote(
      '63',
      ...
      'Productivity',
      'Michael Altshuler'),
  Quote('64', 'Tomorrow hopes we have learned something from yesterday.',
      'Productivity', 'Mark Twain'),
  Quote('65', "Don't watch the clock; do what it does. Keep going.",
      'Productivity', 'John Wooden'),
  Quote(
      '66',
  ...
  Quote(
      ...
      'Productivity',
      'Samuel Johnson'),
  Quote('70', 'Lost time is never found.', 'Productivity', 'Michael Jordan'),
  Quote(
      '71',
  ...
  Quote(
      ...
      'Productivity',
      'Michael Jordan'),
  Quote('81', "Nothing in the world can take the place of persistence.",
      'Productivity', 'Samuel Johnson'),
  Quote('82', "Work hard, have fun, and make history.", 'Productivity',
      'Alexander the Great'),
  Quote(
      '83',
  ...
  Quote(
      ...
      'Productivity',
      'Mark Twain'),
  Quote('85', 'The merit in action lies in finishing it to the end.',
      'Productivity', 'John Wooden'),
  Quote(
      '86',
  ...
  Quote(
      ...
      'Productivity',
      '-Henry David Thoreau'),
  Quote('89', 'If you want something done, give it to a busy man.',
      'Productivity', 'Samuel Johnson'),
  Quote('90', 'The key to productivity is to rotate your avoidance techniques.',
      'Productivity', 'Michael Jordan'),
  Quote(
      '91',
  ...
  Quote(
      ...
      'Productivity',
      'Arnold Schwarzenegger'),
  Quote('97', 'Multitasking is a lie.', 'Productivity', 'Vince Lombardi'),
  Quote(
      '98',
      ...
      'Productivity',
      '-Henry David Thoreau'),
  Quote('99', "It is not the mountain we conquer, but ourselves.",
      'Productivity', 'Samuel Johnson'),
  Quote(
      '100',
  ...
  Quote(
      ...
      'life',
      'Michael Jordan'),
  Quote('1', 'When you have a dream, you’ve got to grab it and never let go.',
  ...
  Quote(
      ...
      'Inspiration',
      'Michael Jordan'),
  Quote('21', 'Nothing is impossible. The word itself says ‘I’m possible!.',
      'Inspiration', 'Carol Burnett'),
  Quote('22', 'There is nothing impossible to they who will try.',
      'Inspiration', 'Alexander the Great'),
  Quote('23', 'The bad news is time flies. The good news is you’re the pilot.',
      'Inspiration', 'Michael Altshuler'),
  Quote(
      '24',
      'Life has got all those twists and turns. You’ve got to hold on tight and off you go.',
      'Inspiration',
  ...
  Quote(
      ...
      'Inspiration',
      'Mark Twain'),
  Quote('35', 'Spread love everywhere you go.', 'Inspiration', 'John Wooden'),
  Quote(
      '36',
      'Do not allow people to dim your shine because they are blinded. Tell them to put some sunglasses on.',
      'Inspiration',
  ...
  Quote(
      ...
      'Inspiration',
      'Michael Altshuler'),
  Quote('44', 'Belief creates the actual fact.', 'Inspiration', 'Mark Twain'),
  Quote(
      '45',
  ...
  Quote(
      ...
      'Inspiration',
      '-Henry David Thoreau'),
  Quote('49', 'Believe you can and you’re halfway there.', 'Inspiration',
      'Samuel Johnson'),
  Quote('50', 'Weaknesses are just strengths in the wrong environment.',
      'Inspiration', 'Joseph Campbell'),
  Quote(
      '51',
      'Just don’t give up trying to do what you really want to do. Where there is love and inspiration, I don’t think you can go wrong.',
      'Inspiration',
      'Audrey Hepburn'),
  Quote('52', 'Silence is the last thing the world will ever hear from me.',
      'Inspiration', 'Alexander the Great'),
  Quote('53', 'In a gentle way, you can shake the world.', 'Inspiration',
      'Michael Altshuler'),
  Quote(
      '54',
  ...
  Quote(
      ...
      'Inspiration',
      '-Henry David Thoreau'),
  Quote('59', 'Try to be a rainbow in someone’s cloud.', 'Inspiration',
      'Samuel Johnson'),
  Quote(
      '60',
  ...
  Quote(
      ...
      'Inspiration',
      'Nicole Kidman'),
  Quote('62', 'Real change, enduring change, happens one step at a time.',
      'Inspiration', 'Amy Poehler'),
  Quote('63', 'Nobody built like you, you design yourself.', 'Inspiration',
      'T.S Eliot'),
  Quote(
      '64',
  ...
  Quote(
      ...
      'Inspiration',
      'John Wooden'),
  Quote('66', 'Live your beliefs and you can turn the world around.',
  ...
  Quote(
      ...
      'Inspiration',
      'Samuel Johnson'),
  Quote('70', 'There’s nothing more powerful than not giving a f—k.',
      'Inspiration', 'Joseph Campbell'),
  Quote('71', 'Faith is love taking the form of aspiration.', 'Inspiration',
      'Audrey Hepburn'),
  Quote(
      '72',
  ...
  Quote(
      ...
      'Inspiration',
      'Michael Altshuler'),
  Quote('74', 'We are not our best intentions. We are what we do.',
      'Inspiration', 'Mark Twain'),
  Quote(
      '75',
  ...
  Quote(
      ...
      'Samuel Johnson'),
  Quote(
      '80', 'How wild it was, to let it be.', 'Inspiration', 'Joseph Campbell'),
  Quote(
      '81',
      'The simple act of listening to someone and making them feel as if they have truly been heard is a most treasured gift.',
      'Inspiration',
      'Audrey Hepburn'),
  Quote('82', 'It is never too late to be what you might have been.',
      'Inspiration', 'Alexander the Great'),
  Quote('83', 'You do not find the happy life. You make it.', 'Inspiration',
      'Michael Altshuler'),
  Quote(
      '84',
  ...
  Quote(
      ...
      'Inspiration',
      'Vince Lombardi'),
  Quote('88', 'Being vulnerable is a strength, not a weakness.', 'Inspiration',
      '-Henry David Thoreau'),
  Quote('89', 'Let love rule.', 'Inspiration', 'Samuel Johnson'),
  Quote('90', 'Embrace the glorious mess that you are.', 'Inspiration',
      'Joseph Campbell'),
  Quote(
      '91',
      ...
      'Inspiration',
      'Nicole Kidman'),
  Quote('92', 'Being vulnerable is a strength, not a weakness.', 'Inspiration',
      'Amy Poehler'),
  Quote(
      '93',
      ...
      'Inspiration',
      'T.S Eliot'),
  Quote('94', 'Definitions belong to the definers, not the defined.',
      'Inspiration', 'Mark Twain'),
  Quote(
      '95',
